...
echo -e "$(date +"%m/%d %H:%M:%S") ${INFO} Download error or stop, start deleting files..." >> ./downloads/downlog.txt
...
echo -e "$(date +"%m/%d %H:%M:%S") ${INFO} Download error or stop, start deleting files finish" >> ./downloads/downlog.txt
